...
public class RxBus {
    ...
    private void addEventTypeToMap(Object subscriber, Class eventType) {
        List<Class> eventTypes = (List)this.eventTypesBySubscriber.get(subscriber);
        if (eventTypes == null) {
    ...
    private void addSubscriberToMap(Class eventType, SubscriberMethod subscriberMethod) {
        List<SubscriberMethod> subscriberMethods = (List)this.subscriberMethodByEventType.get(eventType);
    ...
    private void addSubscriptionToMap(Class eventType, Disposable disposable) {
        List<Disposable> disposables = (List)this.subscriptionsByEventType.get(eventType);
        if (disposables == null) {
    ...
    private void addSubscriber(final SubscriberMethod subscriberMethod) {
        ...
        Disposable subscription = this.postToObservable(flowable, subscriberMethod).subscribe(new Consumer<Object>() {
    ...
    private void callEvent(SubscriberMethod method, Object object) {
        ...
        List<SubscriberMethod> methods = (List)this.subscriberMethodByEventType.get(eventClass);
    ...
    public void unregister(Object subscriber) {
        List<Class> subscribedTypes = (List)this.eventTypesBySubscriber.get(subscriber);
